        ...
        <div class="inner-hero-header">
            <div class="container">
                ...
                <div class="relative">
                    ...
                    <!-- form search -->
                    <form class="form-search-home" action="{{url('joblist')}}">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-t-primary btn-lg btn-theme btn-pill btn-block">Търси</button>
                        </div>
                        <div class="text-center">
                            <a href="#modal-advanced" data-toggle="modal">Продробно търсене</a>
                        </div>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="color-text">Регистрирани потребители</h4>
                    </div>
                    <div class="col-md-4">
                        <h3 class="font-2x ">3,603,945</h3>
                        <h4 class="color-text">Стажове, курсове и обяви за работа</h4>
                    </div>
                    <div class="col-md-4">
                        <h3 class="font-2x ">53,945</h3>
                        <h4 class="color-text">Компании</h4>
                    </div>
                </div>
            </div>
